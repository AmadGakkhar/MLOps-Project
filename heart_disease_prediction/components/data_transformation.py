...
from heart_disease_prediction.constants import (
    TARGET_COLUMN,
    SCHEMA_FILE_PATH,
    PREPROCESSOR_PATH,
)
...
# from heart_disease_prediction.entity.estimator import TargetValueMapping
    ...
    def initiate_data_transformation(
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                # print(
                #     "Data Transformation: Shape of data before transfomration",
                #     np.shape(input_feature_test_df),
                # )
                input_feature_test_arr = preprocessor.transform(input_feature_test_df)
                # print(
                #     "Data Transformation: Shape of data after transfomration",
                #     np.shape(input_feature_test_arr),
                # )
