...
from heart_disease_prediction.components.data_access import StrokeData

### IMPORT The module which reads the data from db and returns the df####
### Should be written in the form of a class. Maybe in utils folder.####
### We should be able to import it as
### from heart_disease_prediction.utils import {module_name}
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = stroke_data.export_collection_as_dataframe(
